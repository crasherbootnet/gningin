...
class ActivitesController extends Controller
{
    ...
    public function create($short_code)
    {
        ...
        return view('bayeurs.projects.activites.create', ['project' => $project]);
    }
    ...
    {   
        ...
        return redirect('bayeurs.projects/activites/'.$short_code);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function show($activite_short_code)
    {
        ...
        $project = $activite->project;

        return view('bayeurs.projects.activites.view', ['project' => $project, 'activite' => $activite]);
    }
    ...
    public function edit($project_short_code, $activite_short_code)
    {
        ...
        return view('bayeurs.projects.activites.edit', ['project' => $project, 'activite' => $activite]);
    }
    ...
    public function update(Request $request, $project_short_code, $activite_short_code)
    {
        ...
        return redirect('bayeurs.projects/activites/'.$project->short_code);
    }
