...
<html lang="en">
    <head>
        ...
        <link href="{{ secure_asset('assets/css/light-bootstrap-dashboard.css') }}" rel="stylesheet"/>


        <!--  CSS for Demo Purpose, don't include it in your project     -->
        <link href="{{ secure_asset('assets/css/demo.css') }}" />
        ...
        <script src="{{ secure_asset('assets/js/bootstrap-checkbox-radio-switch.js') }}"></script>
        ...
        <script src="{{ secure_asset('assets/js/light-bootstrap-dashboard.js') }}"></script>
