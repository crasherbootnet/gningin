...
<ul id="sidebarnav">
    <li> 
        <a class="has-arrow waves-effect waves-dark" href="{{ url('projects/historisations/'.$projectHistorisation->project->short_code) }}" aria-expanded="false">
            ...
            <ul aria-expanded="false" class="collapse">
                @foreach($projectHist->projectshistorisations as $historisation)
                    @if($projectHistorisation->id == $historisation->id)
                        <li class="active"><a href="{{ url('projects/historisations-versions/'.$historisation->id) }}">{{ $historisation->created_at }}</a></li>
                    @else
                        <li><a href="{{ url('projects/historisations-versions/'.$historisation->id) }}">{{ $historisation->created_at }}</a></li>
                    @endif
                @endforeach
            </ul>
        </li>
                        ...
                        <p>
                            <div class="row">
                                @if($projectHistorisation->project->projectsCategories->where('categorie_id', 1)->first())
                                    <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-context') }}/{{ $projectHistorisation->id }}">
                                        <div class="info-box">
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-justificatif') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-objectifs') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                        <div class="info-box-content">
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-cible') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-resultats') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-composante') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-methodologie') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-hypothese') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-activites') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-cadre-logique') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-execution') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                ...
                                <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('projects/historisation-amendements') }}/{{ $projectHistorisation->id }}">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-red"></span>
                                        <div class="info-box-content">
                                          <span class="info-box-text">Amendements</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
