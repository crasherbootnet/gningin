					...
					<div class="panel-body" style="display: block">
						<p>
							<div class="row">
							    ...
							    <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('bayeurs/ong/project-justificatif/') }}/{{ $project->short_code }}">
							        <div class="info-box">
							            <span class="info-box-icon bg-red"></span>
							    ...
							    <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('bayeurs/ong/project-objectifs/') }}/{{ $project->short_code }}">
							        <div class="info-box">
							            <span class="info-box-icon bg-red"></span>
							            <div class="info-box-content">
							    ...
							    <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('bayeurs/ong/project-composante/') }}/{{ $project->short_code }}">
							        <div class="info-box">
							            <span class="info-box-icon bg-red"></span>
							    ...
							    <a class="col-md-3 col-sm-6 col-xs-12" href="{{ url('bayeurs/ong/project-cadre-logique/') }}/{{ $project->short_code }}">
							        <div class="info-box">
							            <span class="info-box-icon bg-red"></span>
