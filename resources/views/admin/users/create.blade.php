...
<div style="margin: 0% 22%;">
		<h3 style="text-align: center">Bienvenue dans la création d'un access pour un bayeur de fond</h3>
		<form action="{{ url('/admin/users')}}" method="POST" class="box box-success">
			@csrf
